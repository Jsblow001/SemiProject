    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <h4 class="mb-4">Receive messages instantly with our PHP and Ajax contact form - available in the <a href="https://htmlcodex.com/downloading/?item=1176">Pro Version</a> only.</h4>
                <form>
