...
public class AdminMemberSmsSend extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
	    ...
	    paraMap.put("from", "01042303159"); // 발신번호
	    ...
	    /*
        org.json.JSONObject 이 아니라  (이메일)
        org.json.simple.JSONObject 이어야 한다.  (문자)
       */
	    
	    String json = jsObj.toString();
	    
	    //System.out.println("확인용 : " + json);
	    // 확인용 : {"group_id":"R2GWPBT7UoW308sI","success_count":1,"error_count":0}
